(function () {
  ...
  (function (factory) {
      ...
      function spectrum(element, o) {
          ...
          function dragStart() {
              ...
              shiftMovementDirection = null;
              boundElement.trigger('dragstart.spectrum', [get$$1()]);
          }

          function dragStop() {
              isDragging = false;
              container.removeClass(draggingClass);
              boundElement.trigger('dragstop.spectrum', [get$$1()]);
          }
          ...
          function show() {
              ...
              boundElement.trigger(event, [get$$1()]);

              if (callbacks.beforeShow(get$$1()) === false || event.isDefaultPrevented()) {
                  return;
              }
          ...
          function hide() {
              ...
              callbacks.hide(get$$1());
              boundElement.trigger('hide.spectrum', [get$$1()]);
          }
          ...
          function _set(color, ignoreFormatChange) {
              if (tinycolor.equals(color, get$$1())) {
          ...
          function move() {
              ...
              callbacks.move(get$$1());
              boundElement.trigger('move.spectrum', [get$$1()]);
          }
          ...
          function updateUI() {
              ...
              var realColor = get$$1({ format: format }),
                  displayColor = '';
  ...
  var tabs = document.querySelector('[data-js-tabstats]');

  if (tabs) {
      var header = tabs.querySelector('[data-js-header]');
      var headerChildren = Array.from(header.querySelectorAll('[data-js]'));
      var bodyChildren = Array.from(tabs.querySelectorAll('[data-js-body]'));

      header.addEventListener('click', function (e) {
          var target = e.target;


          if (target.hasAttribute('data-js') && !target.hasAttribute('data-active')) {
              var indexTarget = void 0;

              headerChildren.forEach(function (el, index) {
                  if (el === target) {
                      indexTarget = index;
              ...
              bodyChildren.forEach(function (el, index) {
  ...
  function updateCSS() {
      var style = document.querySelector('[data-js-realTimeFeedback-style-poll]');

      if (!style) {
          style = document.createElement('style');
          style.type = 'text/css';
          style.setAttribute('data-js-realTimeFeedback-style-poll', '');
          document.head.appendChild(style);
      }

      var css = '';
      Object.keys(poll.css).forEach(function (key) {
          css += key + " {";

          Object.keys(poll.css[key]).forEach(function (key2) {
              css += key2 + ": " + poll.css[key][key2] + ";";
          });
  ...
  function updateHTML() {
      ...
      document.querySelector('[data-js-realTimeFeedback-preview]').innerHTML = template;
  }

  function updateOption(param, target) {
      poll.data[param] = target.value;
      updateHTML();
  ...
  function enableSaveButton() {
      document.querySelector('[data-js-saveButton]').removeAttribute('disabled');
  }

  if (document.querySelector('[data-js-realTimeFeedback-preview]')) {
      requestIdleCallback(function () {
          var timeout = null;

          var _loop = function _loop(target) {
              var param = target.getAttribute('data-js-realTimeFeedback-option');

              poll.data[param] = target.value;

              if (target.nodeName === 'SELECT') {
                  target.addEventListener('change', updateOption.bind(null, param, target));
              } else {
                  target.addEventListener('keyup', function () {
                      clearTimeout(timeout);
                      timeout = setTimeout(updateOption.bind(null, param, target), 400);
                  });
              }
          };
          ...
          try {
              for (var _iterator = document.querySelectorAll('[data-js-realTimeFeedback-option]')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          try {
              for (var _iterator2 = document.querySelectorAll('[data-js-realTimeFeedback-spectrum]')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                  var target = _step2.value;

                  poll.css['.realTimeFeedback-poll'][target.getAttribute('data-js-realTimeFeedback-spectrum')] = target.value;
              }
          ...
          var fontTarget = document.querySelector('[data-js-realTimeFeedback-font]');
          poll.css['.realTimeFeedback-poll']['font-family'] = fontTarget.value;
          fontTarget.addEventListener('keyup', function () {
              poll.css['.realTimeFeedback-poll']['font-family'] = fontTarget.value;
              updateCSS();
              enableSaveButton();
          });
      ...
      jQuery('[data-js-realTimeFeedback-spectrum]').spectrum({
          showInput: true,
          showAlpha: true,
          showPalette: true,
          maxSelectionSize: 5,
          ...
          showButtons: false,
          preferredFormat: 'rgb',
          palette: [['#fff', '#ccc', '#333'], ['#e4423c', '#90c54d', '#7044bf'], ['#247dd6', '#f7d913', '#5ed0da']],
          move: function move(color) {
              var colorRGB = color.toRgbString();

              poll.css['.realTimeFeedback-poll'][this.getAttribute('data-js-realTimeFeedback-spectrum')] = colorRGB;
              this.value = colorRGB;
